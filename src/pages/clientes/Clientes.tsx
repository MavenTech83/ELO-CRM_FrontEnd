    ...
    <Layout>
        <div className="h-full flex items-center justify-center gap-2">
				...
				<div className="h-full w-1/2">
					<div className="bg-white/10 rounded-3xl p-2 shadow h-full overflow-y-auto scroll-smooth">
				...
				<div className=" h-full w-1/2 gap-2">
						<div className="h-2/3 bg-white/10 p-4 rounded-4xl shadow overflow-y-auto">
